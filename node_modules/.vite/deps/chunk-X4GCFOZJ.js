...
var Slot3 = React11.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime7.jsx)(SlotClone3, { ...slotProps, ref: forwardedRef, children: React11.isValidElement(newElement) ? React11.cloneElement(newElement, void 0, newChildren) : null });
  }
  return (0, import_jsx_runtime7.jsx)(SlotClone3, { ...slotProps, ref: forwardedRef, children });
});
Slot3.displayName = "Slot";
var SlotClone3 = React11.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
...
function isSlottable3(child) {
  return React11.isValidElement(child) && child.type === Slottable3;
}
...
//# sourceMappingURL=chunk-X4GCFOZJ.js.map
